...
推送到 `main` 后，CI 会在 **Ubuntu 20.04 ARM64 容器**（glibc 2.31，indygreg 便携 Python 3.10）里构建 `.deb`，兼容麒麟 V10 等较旧的 ARM 系统，并在 Releases / Artifacts 中提供下载。详见 [docs/KYLIN_BUILD.md](docs/KYLIN_BUILD.md)。
